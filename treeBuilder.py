...
input5 = str('미래창조과학부는 과학기술정책과 정보통신기술(ICT)에 관한 사무를 관장하는 중앙행정기관이다.')
input6 = str('국토교통부는 국토의 체계적인 개발과 보존, 교통물류체계 구축 등의 사무를 관장하는 중앙행정기관이다.')
...
for taggedList in aa:
	...
	for i in realIndexList:
		...
		while True:
			...
			if tagSeq[mainPointer-1] in caseSpecificTagSet:
				if tagSeq[i-adjust] == 'ETM':
					#tree.append([mainPointer, i, 'MM'])
